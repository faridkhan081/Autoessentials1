const styles = {
    ...
    shop_name:"pt-1 text-[15px] text-blue-400 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'w-[150px] bg-black hover:bg-green-500 h-[50px] my-3 flex items-center justify-center rounded cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded bg-[#f63b60] flex items-center justify-center cursor-pointer",
