...
const Navbar = ({ active }) => {
  ...
  return (
    ...
    <button className=" text-white mt-[1px] py-2 px-2 rounded inline-flex items-center group 370px:bg-rose-600 lg:bg-transparent">
    ...
    {/* menu list */}
    <ul className="rounded absolute hidden text-black lg:pt-[16px] 370px:pt-2 group-hover:block w-40 z-10">
