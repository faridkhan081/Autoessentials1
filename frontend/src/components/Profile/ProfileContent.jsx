...
import { deleteUserAddress, loadUser, updateUserAddress, updateUserInfo } from "../../redux/actions/user";
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            ...
            />
            <input
              className={`w-[95%] h-[40px] border border-[#3ad132] border-500 bg-[#3ad132] text-white transition hover:bg-transparent hover:text-[#3ad132] focus:outline-none focus:ring active:test-rose-500 rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
              type="submit"
            />
...
const UserAddress = () => {
  ...
  return (
    <>
      <div className="w-full px-5">
        {open && (
          <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex justify-center items-center">
            <div className="w-[35%] h-[80vh] bg-white rounded shadow relative overflow-y-scroll p-3">
